...
const Hero = () => {
    ...
    return (
        <div className="relative h-dvh w-screen overflow-x-hidden ">
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-2xl bg-blue-75">

                {/* banner video div */}
                <div>
                    {/* center Video */}
                    <div className="hex-poly absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
